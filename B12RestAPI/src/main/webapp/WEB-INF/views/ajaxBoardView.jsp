...
<body>
	<div class="container">
		...
		<div>
			<input type="number" id="Num" value="${param.num }"> <input
				type="button" value="내용불러오기" id="btnBoard" />
				<input type="button" value="목록바로가기" onclick="location.href='ajaxBoardList.do';" />
		</div>
	</div>
</body>
</html>